...
Related documentation available at: [Charmander](https://github.com/att-innovate/charmander)

Reset Charmander to a clean state
...
The code can be found in Github in [MaxUsage.scala](https://github.com/att-innovate/charmander-experiment-maxusage/blob/master/analytics/maxusage/src/main/scala/MaxUsage.scala).
...
Change your working directory to the root of your Charmander installation.

	cd charmander

Change to the experiments folder and check out the code into a folder called `maxusage`
